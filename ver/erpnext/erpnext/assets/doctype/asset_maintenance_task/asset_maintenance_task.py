...
class AssetMaintenanceTask(Document):
	...
	if TYPE_CHECKING:
		from erpnext.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import AssetRepairConsumedItem
		from frappe.types import DF

		asset_repair_consumed_item: DF.Table[AssetRepairConsumedItem]
		...
		parentfield: DF.Data
		parenttype: DF.Data
		periodicity: DF.Literal["", "Daily", "Weekly", "Monthly", "Quarterly", "Half-yearly", "Yearly", "2 Yearly", "3 Yearly"]
		start_date: DF.Date
