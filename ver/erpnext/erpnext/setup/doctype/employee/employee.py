...
class Employee(NestedSet):
	...
	if TYPE_CHECKING:
		...
		accommodation_bonus: DF.Float
		additional_compensation: DF.Float
		attendance_device_id: DF.Data | None
		bank_ac_no: DF.Data | None
		bank_name: DF.Data | None
		basic_salary: DF.Currency
		bio: DF.TextEditor | None
		blood_group: DF.Literal["", "A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"]
		branch: DF.Link | None
		calendar: DF.Literal[None]
		car_allocated: DF.Check
		category: DF.Int
		cell_number: DF.Data | None
		children_count: DF.Float
		cin: DF.Data | None
		civil_status: DF.Literal["C\u00e9libataire", "Mari\u00e9(e)", "Divorc\u00e9(e)", "Veuf(ve)"]
		cnam: DF.Data | None
		cnss: DF.Data | None
		coef_perf: DF.Float
		company: DF.Link
		...
		cycle: DF.Literal[None]
		daily_attendance_rate: DF.Float
		...
		first_name: DF.Data
		function: DF.Literal[None]
		function_bonus_rate: DF.Float
		functional_bonus: DF.Currency
		gender: DF.Link
		gta_validator: DF.Literal[None]
		has_advance: DF.Check
		has_loan: DF.Check
		health_details: DF.SmallText | None
		held_on: DF.Date | None
		holiday_list: DF.Link | None
		housing_provided: DF.Check
		iban: DF.Data | None
		image: DF.AttachImage | None
		index: DF.Int
		internal_work_history: DF.Table[EmployeeInternalWorkHistory]
		irpp_applicable: DF.Check
		last_name: DF.Data | None
		leave_encashed: DF.Literal["", "Yes", "No"]
		lft: DF.Int
		liability_premium_rate: DF.Float
		marital_status: DF.Literal["", "Single", "Married", "Divorced", "Widowed"]
		meal_allowance_rate: DF.Float
		meal_reimbursement_amount: DF.Currency
		meals_reimbursed: DF.Check
		middle_name: DF.Data | None
		monthly_car_benefit_amount: DF.Currency
		monthly_housing_benefit_amount: DF.Currency
		...
		performance_bonus: DF.Float
		performance_bonus_rate: DF.Float
		performance_score: DF.Float
		...
		phone_reimbursement_amount: DF.Currency
		place_of_issue: DF.Data | None
		population: DF.Literal[None]
		...
		seniority_bonus_rate: DF.Float
		seniority_in_years: DF.Float
		shopping_cart_bonus: DF.Float
		start_date: DF.Date | None
		status: DF.Literal["Active", "Inactive", "Suspended", "Left"]
		submission_to_checkin: DF.Check
		submission_to_the_gta: DF.Check
		telephone_reimbursed: DF.Check
		transport_allowance_rate: DF.Float
		transport_bonus: DF.Float
