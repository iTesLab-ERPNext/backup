frappe.listview_settings["Customer"] = {
	...
	formatters: {
        name: function(value, doc) {
            ...
            const itemUrl = `${baseUrl}/app/query-report/Customer%20Transactions?customer=${encodeURIComponent(value)}&valuation_field_type=Currency`;
            ...
            return `<a href="javascript:void(0)" 
                        ...
                        <i class="fa fa-file" aria-hidden="true" 
                           ...
                           title="${__("See customer transactions")}"></i>
                    </a>`;
        }
    }
};
...
window.openReportPopup = function(customer_name, reportUrl) {
    const dialog = new frappe.ui.Dialog({
        title: `${__("Customer Transactions")} : ${customer_name}`,
        fields: [
    ...
    // Appel du rapport avec le filtre customer
    frappe.call({
        method: "frappe.desk.query_report.run",
        args: {
            report_name: "Customer Transactions",
            filters: { customer: customer_name }  // Utilisation du filtre 'customer'
        },
...
function formatReportHTML(data) {
    ...
    const columns = [
        ...
        { "label": __("Voucher No"), "fieldname": "voucher_no", "fieldtype": "Dynamic Link", "options": "voucher_type", "width": 200 },
        { "label": __("Sales"), "fieldname": "debit", "fieldtype": "Currency", "width": 150 },
        { "label": __("Payments"), "fieldname": "credit", "fieldtype": "Currency", "width": 150 },
    ...
    data.forEach(row => {
        ...
        columns.forEach(col => {
            ...
            // Appliquer les couleurs uniquement pour les colonnes "Ventes", "Paiements" et "Solde"
