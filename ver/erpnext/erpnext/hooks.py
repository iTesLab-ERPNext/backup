...
app_include_css = [
	"erpnext.bundle.css",
    "/assets/erpnext/css/custom_styles.css"
] 
...
website_context = {
	"favicon": "/assets/frappe/images/erp.svg",
	"splash_image": "/assets/frappe/images/erp.svg",
}
...
website_route_rules = [
    ...
    {"from_route": "/employee", "to_route": "Employee"},
    ...
    {"from_route": "/absence-tracking", "to_route": "Attendance"},
    {
        "from_route": "/absence-tracking/<path:name>",
        "to_route": "absence_tracking_info",
        "defaults": {
            "doctype": "Attendance",
            "parents": [{"label": "Absence tracking", "route": "absence-tracking"}],
        },
    },
    {"from_route": "/employee-checkin", "to_route": "Employee Checkin"},
    {"from_route": "/employee-checkin-new", "to_route": "employee-checkin-new"},
    {
        "from_route": "/employee-checkin/<path:name>",
        "to_route": "employee_checkin_info",
        "defaults": {
            "doctype": "Employee Checkin",
            "parents": [{"label": "Employee Checkin", "route": "employee-checkin"}],
        },
    },
    {"from_route": "/leave-application", "to_route": "Leave Application"},

    {
        "from_route": "/leave-application/<path:name>",
        "to_route": "leave_application_info",
        "defaults": {
            "doctype": "Leave Application",
            "parents": [{"label": "Leave Application", "route": "leave-application"}],
        },
    },
